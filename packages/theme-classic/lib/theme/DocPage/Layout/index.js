...
const BackToTopButton_1 = tslib_1.__importDefault(
  require('@theme/BackToTopButton'),
);
const Sidebar_1 = tslib_1.__importDefault(
  require('@theme/DocPage/Layout/Sidebar'),
);
...
function DocPageLayout({children}) {
  ...
  return react_1.default.createElement(
    Layout_1.default,
    {wrapperClassName: styles_module_css_1.default.docsWrapper},
    react_1.default.createElement(BackToTopButton_1.default, null),
    react_1.default.createElement(
      'div',
      {className: styles_module_css_1.default.docPage},
      sidebar &&
      ...
      react_1.default.createElement(
        'div',
        {className: styles_module_css_1.default.mainWrapper},
