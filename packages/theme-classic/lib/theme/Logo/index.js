...
function Logo(props) {
    ...
    const logoLink = (0, useBaseUrl_1.default)((logo === null || logo === void 0 ? void 0 : logo.href) || '/');
    // If visible title is shown, fallback alt text should be
    // an empty string to mark the logo as decorative.
    const fallbackAlt = 'site logo';
    // Use logo alt text if provided (including empty string),
    // and provide a sensible fallback otherwise.
    const alt = (_a = logo === null || logo === void 0 ? void 0 : logo.alt) !== null && _a !== void 0 ? _a : fallbackAlt;
    const { html: logoHtml, ...logoRest } = logo.after || {};
    return (react_1.default.createElement("div", { className: index_module_scss_1.default.logo },
        react_1.default.createElement(Link_1.default, { to: logoLink, ...propsRest, ...((logo === null || logo === void 0 ? void 0 : logo.target) && { target: logo.target }) }, logo && react_1.default.createElement(LogoThemedImage, { logo: logo, alt: alt, imageClassName: imageClassName })),
        logo.after && (react_1.default.createElement("div", { dangerouslySetInnerHTML: { __html: logoHtml }, ...logoRest, className: (0, clsx_1.default)(index_module_scss_1.default.logoAfter, logoRest.class, 'logo__after') }))));
}
