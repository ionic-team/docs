...
const ProductDropdown_1 = tslib_1.__importDefault(require("../../ProductDropdown"));
...
const CollapseButton_1 = tslib_1.__importDefault(require("@theme/DocSidebar/Desktop/CollapseButton"));
const Content_1 = tslib_1.__importDefault(require("@theme/DocSidebar/Desktop/Content"));
const styles_module_scss_1 = tslib_1.__importDefault(require("./styles.module.scss"));
function DocSidebarDesktop({ path, sidebar, onCollapse, isHidden }) {
    //TODO: strongly typed theme config
    const { navbar: { hideOnScroll }, docs: { sidebar: { hideable }, }, sidebar: { backButton, versionDropdown }, } = (0, theme_common_1.useThemeConfig)();
    ...
    return (react_1.default.createElement("div", { className: (0, clsx_1.default)(styles_module_scss_1.default.sidebar, hideOnScroll && styles_module_scss_1.default.sidebarWithHideableNavbar, isHidden && styles_module_scss_1.default.sidebarHidden) },
        react_1.default.createElement("div", { className: styles_module_scss_1.default.sidebarTop },
            backButton && (react_1.default.createElement("a", { ...backButton.url, className: (0, clsx_1.default)(styles_module_scss_1.default.backButton, backButton.class, 'back-button') },
            ...
            react_1.default.createElement("div", { className: styles_module_scss_1.default.sidebarTopEnd },
