...
const ColorModeToggle_1 = tslib_1.__importDefault(
  require('@theme/Navbar/ColorModeToggle'),
);
...
function NavbarMobileSidebarHeader() {
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(ColorModeToggle_1.default, {
