...
function LocaleDropdownNavbarItem({ mobile, dropdownItemsBefore, dropdownItemsAfter, ...props }) {
    ...
    return (react_1.default.createElement(DropdownNavbarItem_1.default, { ...props, mobile: mobile, label: react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(Language_1.default, null),
            react_1.default.createElement("span", { className: styles_module_css_1.default.localeVisuallyHidden }, dropdownLabel)), items: items }));
}
